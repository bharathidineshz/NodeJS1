...
const SalesOverview = () => {
  ...
  return (
    <Card>
      <CardHeader
        title='Billable and Non Billable tasks'
      ...
      <CardContent>
        <Grid container sx={{ my: [0, 4, 1.625] }}>
          <Grid item xs={12} sm={6} sx={{ mb: [3, 0] }}>
            <ReactApexcharts type='donut' height={220} series={[60, 40]} options={options} />
          </Grid>
          <Grid item xs={12} sm={6} sx={{ my: 'auto' }}>
            <Grid container>
              ...
              <Grid item xs={12} sx={{ mb: 4 }}>
                ...
                >
                  <Icon icon='mdi:circle' />
                  <Typography variant='body2'>Non Billable</Typography>
                </Box>
                <Typography sx={{ fontWeight: 600 }}>40</Typography>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
