...
import TabHolidayManagement from 'src/views/pages/account-settings/TabHolidayManagement'
...
const AccountSettings = ({ tab, apiPricingPlanData }) => {
  ...
  const tabContentList = {
    ...
    holidaymanagement: <TabHolidayManagement />,
